...
def buscar_semantico(query: str, agent_id: str, limit: int = 10) -> list:
    ...
    try:
        ...
        results = search_client.search(
            ...
            select=["id", "agent_id", "endpoint",
                    "timestamp", "texto_semantico"],
            top=limit
        )
        ...
        return [
            {
                ...
                "texto_semantico": safe_texto_semantico(r),
...
def memoria_hibrida(req: func.HttpRequest) -> func.HttpResponse:
    ...
    try:
        ...
        agent_id = req.headers.get(
            "Agent-ID") or req.params.get("agent_id", "GlobalAgent")
            ...
            resultados = [
                {
                    ...
                    "texto_semantico": safe_texto_semantico(item),
                    "fuente": "cosmos_db"
                }
                for item in items
            ]
