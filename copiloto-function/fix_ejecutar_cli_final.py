...
# -*- coding: utf-8 -*-
"""
Fix definitivo para /api/ejecutar-cli - Nunca HTTP 400, siempre autocorrección con memoria
"""
...
def generar_fix_ejecutar_cli():
    """Genera el código corregido para ejecutar_cli_http"""
    
    # Función auxiliar para autocorrección con memoria
    autocorrection_code = '''
...
'''
    ...
    return autocorrection_code + "\n\n" + main_function

if __name__ == "__main__":
    fix_code = generar_fix_ejecutar_cli()
    
    with open('ejecutar_cli_fixed.py', 'w', encoding='utf-8') as f:
        f.write(fix_code)
    
    print("Fix generado en ejecutar_cli_fixed.py")
    print("\nCambios principales:")
    print("1. NUNCA devuelve HTTP 400/500 - siempre HTTP 200")
    print("2. Autocorreccion con memoria para argumentos faltantes")
    print("3. Reejecutar comando si se encuentra valor en memoria")
    print("4. Respuestas adaptativas con preguntas contextuales")
    print("5. Memoria manual aplicada en TODAS las respuestas")