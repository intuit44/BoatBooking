...
def test_payload_incorrecto_intencion():
    ...
    try:
        ...
        if response.status_code == 422:
            ...
            print(f"   FAIL - Esperaba 422, recibio {response.status_code}")
            return False
...
def test_payload_vacio():
    ...
    try:
        ...
        if response.status_code == 400:
            print("   PASS - Payload vacio rechazado correctamente (400)")
            return True
        else:
            print(f"   FAIL - Esperaba 400, recibio {response.status_code}")
            return False
...
def test_payload_mixto():
    ...
    try:
        ...
        if response.status_code in [200, 500]:
            ...
            print(f"   FAIL - Payload mixto fallo inesperadamente")
            return False
